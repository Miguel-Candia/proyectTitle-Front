            ...
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="flex-grow flex items-center justify-center">
                    <ul className="flex space-x-8">
                        <li>
                            <a href="/chat" className=" hover:bg-gray-700 px-3 py-2 rounded">Chat</a>
                        </li>
                        <li>
                            <a href="/Perfilcliente" className="hover:bg-gray-700 px-3 py-2 rounded">Mi Perfil</a>
                        </li>
                        <li>
                            <a href="#" className="hover:bg-gray-700 px-3 py-2 rounded">Billetera</a>
                        </li>
                    </ul>
                </div>
